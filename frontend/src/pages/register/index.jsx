...
const Register = () => {
    ...
    }, [dispatch, message, error, isAuthenticated, navigate, id]) // [dependancy array]
                    ...
                    <div className="content">
                        ...
                        <form className="form" onSubmit={handleSubmit} >
                            <div className="inputGrid">
                                ...
                                <div className="inputBx">
                                    <select className='gender-select' name="gender" value = {details.gender} onChange={handleChange} required >
